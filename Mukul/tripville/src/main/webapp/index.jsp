...
<meta name="description" content=" The carpool app">

    <title>Tripville &ndash; the CarPool App</title>
...
<div id="layout">
    ...
    <div id="menu">
        <div class="pure-menu pure-menu-open">
            <a class="pure-menu-heading" href="#">Tripshare</a>
    ...
    <div id="main">
        <div class="header">
            <h1>Tripville - the CarPool App</h1>
            <h2>Join Today</h2>
        </div>

        <div class="content">
            <h2 class="content-subhead">About Carpooling</h2>
            <p>
...
In 2009, carpooling represented 43.5% of all trips in the United States and 10% of commute trips. The majority of carpool commutes (over 60%) are "fam-pools" with family members.
            ...
            <div class="pure-g">
                    ...
                    <img class="pure-img-responsive" src="assets/img/carpool-img.jpg" alt="Peyto Lake">
