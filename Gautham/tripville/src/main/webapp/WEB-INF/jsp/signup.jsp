...
<title>Tripville - Member Signup</title>
...
<!-- 								<div class="form-group"> -->
<!-- 									<label for="car" class="col-lg-3 control-label">Register -->
<!-- 									car</label> -->
<!-- 									<div class="col-lg-9"> -->
<!-- 										<input type="button" class="form-control"  -->
<!-- 										id="checkBoxVal" name="next"/> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 								<div  class="form-group"> -->
<!-- 									<label for="carDetails" class="col-lg-3 control-label">Car -->
<!-- 										Name</label> -->
<!-- 									<div class="col-lg-9"> -->
<!-- 										<input path="regno" id="carDetails" type="text" class="form-control" disabled/> -->
<!-- 									</div> -->
<!-- 								</div> -->
...
// 		$("#carDetails").prop("disabled", false);
// 	});
		$(function() {
